...
def main():
    ...
    parser.add_argument('--test-case', type=str, required=True,
                       choices=['pure_rrt', 'corridor_full', 'corridor_position_only', 'corridor_orientation_only'],
    ...
    try:
        ...
        # Write output files
        benchmark.write_csv_files(args.output_dir, args.test_case, run_summary, detail_records)
